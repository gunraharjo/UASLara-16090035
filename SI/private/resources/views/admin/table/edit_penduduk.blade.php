        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                      ...
                      {!! Form::model($penduduk, ['method'=>'patch', 'action'=>['PendudukController@update', $penduduk->nik]]) !!}
                              ...
                              <div class="{{ $errors -> has('jenis_kelamin') ? 'has-error' : 'has-success' }}">
                                ...
                                <div class="">
                                  ...
                                  <div class="demo-radio-button">
                                      <input name="jenis_kelamin" value="{{$penduduk->jenis_kelamin}}" type="radio" id="radio_1"  />
                                      <label for="radio_1">Laki-Laki</label>
                                      <input name="jenis_kelamin" value="{{$penduduk->jenis_kelamin}}" type="radio" id="radio_2" />
                                  ...
                                  <div class="{{ $errors -> has('agama') ? 'has-error' : 'has-success' }}">
                                    ...
                                    <div class="{{ $errors -> has('status_perkawinan') ? 'has-error' : 'has-success' }}">
                                      ...
                                      <div class="">
                                        ...
                                        <div class="demo-radio-button">
                                            <input name="status_perkawinan" value="$penduduk->status_perkawinan" type="radio" id="status_1"  />
                                            <label for="status_1">SUDAH MENIKAH</label>
                                            <input name="status_perkawinan" value="$penduduk->status_perkawinan"  type="radio" id="status_2" />
